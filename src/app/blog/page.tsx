      ...
      <div>
        ...
        <div className="italic text-accented-foreground">
          ...
          <p>
            ...
            LLM-AggreFact dataset, introduced in our paper <a href="https://arxiv.org/pdf/2404.10774" target="_blank" style={{color: '#c0392b'}}>MiniCheck</a>, tests this
            capability. <strong>This leaderboard tracks how well LLMs can fact-check
            LLM-generated content.</strong>
          </p>
          <br/>
          <p>
            <span className="font-bold">✨NEW✨</span> results including
            Llama-3.1, Mistral 2, and a new model from <a href="http://www.bespokelabs.ai" target="_blank" style={{color: '#c0392b'}}>Bespoke Labs</a> (fine-tuned
            on a new version of the data from our MiniCheck paper generated with
            Llama-3.1).
          </p>
          <p>
            <span className="font-bold">✨NEW✨</span> <a href="http://playground.bespokelabs.ai" target="_blank" style={{color: '#c0392b'}}>Demo</a> of the Bespoke model
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-6">
          ...
          <p className="leading-normal">
            ...
            (or multitasked models, like <a href="https://aclanthology.org/2023.acl-long.634.pdf" target="_blank" style={{color: '#c0392b'}}>AlignScore</a>) can be used to produce
        ...
        <div className="space-y-6">
          ...
          <div className="leading-normal">
            ...
            <ul className="list-disc pl-4">
              <li>
                Summarization datasets (<a href="https://aclanthology.org/2023.acl-long.650.pdf" target="_blank" style={{color: '#c0392b'}}>AggreFact-CNN/XSum</a>, <a href="https://aclanthology.org/2024.naacl-long.251.pdf" target="_blank" style={{color: '#c0392b'}}>TofuEval-MeetB/MediaS</a>, <a href="https://arxiv.org/abs/2401.00396" target="_blank" style={{color: '#c0392b'}}>RAGTruth</a>): datasets
                of models trained or prompted for summarizing documents, meeting
                transcripts, etc.
              </li>
              <li>
                Retrieval-augmented generation datasets (<a href="https://aclanthology.org/2023.findings-emnlp.467.pdf" target="_blank" style={{color: '#c0392b'}}>ClaimVerify</a>, <a href="https://arxiv.org/pdf/2310.12150" target="_blank" style={{color: '#c0392b'}}>LFQA</a>, <a href="https://aclanthology.org/2024.naacl-long.167.pdf" target="_blank" style={{color: '#c0392b'}}>ExpertQA</a>, <a href="https://arxiv.org/abs/2401.00396" target="_blank" style={{color: '#c0392b'}}>RAGTruth</a>): datasets of models answering questions from
                retrieved documents.
              </li>
              <li>
                Post-hoc grounding (<a href="https://aclanthology.org/2024.naacl-long.167.pdf" target="_blank" style={{color: '#c0392b'}}>ExpertQA</a>, <a href="https://arxiv.org/pdf/2402.00559" target="_blank" style={{color: '#c0392b'}}>REVEAL</a>, <a href="https://arxiv.org/pdf/2311.09000" target="_blank" style={{color: '#c0392b'}}>Factcheck-GPT</a>): datasets
                where models&apos; answers are generated &quot;closed
                book&quot;, then verified against retrieved documents.
              </li>
              <li>
                Human-written claims (<a href="https://aclanthology.org/2023.emnlp-main.470.pdf" target="_blank" style={{color: '#c0392b'}}>Wice</a>): Wikipedia claims with citations.
              </li>
            </ul>
          </div>
          <p className="leading-normal">
            We have added <a href="https://arxiv.org/abs/2401.00396" target="_blank" style={{color: '#c0392b'}}>RAGTruth</a> to the benchmark since the release of the
            original paper. All of these datasets are labeled for factuality by expert
            annotators. We believe this is an up-to-date collection of high-quality 
            labeled datasets over strong LLM outputs. The MiniCheck paper further
        ...
        <div className="space-y-6">
          ...
          <p className="leading-normal">
            ...
            size. The best performance on the leaderboard comes from a 7B model <a href="https://huggingface.co/bespokelabs/Bespoke-Minicheck-7B" target="_blank" style={{color: '#c0392b'}}>Bespoke-Minicheck-7B</a> that is a fine-tuned version of InternLM2.5. [GREG: not sure what we
          ...
          <p className="leading-normal">
            This model is available as a demo <a href="http://playground.bespokelabs.ai/" target="_blank" style={{color: '#c0392b'}}>here</a>.
          </p>
        </div>
      </div>
      ...
      <div className="space-y-6">
        <div className="space-y-6">
          ...
          <p className="leading-normal">
            ...
            e.g., <a href="https://aclanthology.org/2023.emnlp-main.741.pdf" target="_blank" style={{color: '#c0392b'}}>FActScore</a> and the recent <a href="https://arxiv.org/pdf/2407.17468" target="_blank" style={{color: '#c0392b'}}>WildHallucinations</a>. This is not our
            focus.
          </p>
        </div>
      </div>
